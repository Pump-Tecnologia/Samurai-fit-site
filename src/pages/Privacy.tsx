...
const Privacy: React.FC = () => {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 relative overflow-hidden font-sans selection:bg-red-900/30 selection:text-red-200">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[40rem] h-[40rem] bg-red-900/5 blur-[150px] rounded-full pointer-events-none"></div>
      ...
      <main className="container mx-auto px-6 py-16 relative z-10 max-w-4xl">
         ...
         <div className="mb-16">
           <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tight">
             Política de <span className="text-red-700 font-oriental font-normal drop-shadow-sm">Privacidade</span>
           </h1>
         ...
         <div className="space-y-12 text-zinc-300 leading-relaxed text-lg">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">1. Dados que Coletamos</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">2. Como Usamos seus Dados</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">3. Compartilhamento de Dados</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">4. Segurança dos Dados</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">5. Seus Direitos e Exclusão de Conta</h2>
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-xl mt-4">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">6. Alterações nesta Política</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-100 border-l-4 border-red-700 pl-4">7. Contato e Encarregado de Dados</h2>
              <p>
